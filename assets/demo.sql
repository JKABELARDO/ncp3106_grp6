...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2023 at 05:51 AM
...
CREATE TABLE `add_student` (
  ...
  `studName` int(11) NOT NULL,
  `program` text NOT NULL,
  `currentYear` varchar(10) NOT NULL,
  `birthdayTime` date NOT NULL,
...
INSERT INTO `employees` (`id`, `name`, `address`, `salary`, `date hired`, `job role`) VALUES
(1, 'io', 'gilmore', 10000, '0000-00-00', '');
