                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="GET">
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" name="studentNumber" value="<?php if(isset($_GET['studentNumber'])){echo $_GET['studentNumber'];} ?>" class="form-control">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['studentNumber']))
                                    {
                                        ...
                                        $query = "SELECT * FROM add_student WHERE studentNumber='$studentNumber' ";
